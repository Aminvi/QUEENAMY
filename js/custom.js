(function ($) {
	...
	$(".testimonialsList, .singlefolio,").owlCarousel({ 		  
	   loop:true,
		margin:0,
		nav:false,
...
if ($('.tp-banner').length > 0) {
  $('.tp-banner').show().revolution({
    ...
    startheight: 800,            // required by older versions (keep)
    startwidth: 1170,
    hideThumbs: 1000,
    ...
    autoHeight: 'off',           // 🔥 prevents resize glitch
    fullWidth: 'on',
    fullScreen: 'on',            // 🔥 TRUE fullscreen (key fix)
